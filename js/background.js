var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/ford-gt-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/ford-gt-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/ford-gt-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/ford-gt-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Ford GT?",
				description: "Get awesome Ford GT HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
